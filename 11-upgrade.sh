...
# Command: UPGRADE-5
az aks upgrade -g $resource_group_name -n $aks_name --kubernetes-version 1.26.6 --control-plane-only --yes

# Upgrade nodepool
# Command: UPGRADE-6
az aks nodepool upgrade --name $aks_nodepool1 -g $resource_group_name --cluster-name $aks_name --kubernetes-version 1.26.6 --yes

# Option 2: Let AKS manage the upgrade
# Command: UPGRADE-7
az aks upgrade -g $resource_group_name -n $aks_name --kubernetes-version 1.26.6 --yes
